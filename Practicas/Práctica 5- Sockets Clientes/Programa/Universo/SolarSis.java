...
public class SolarSis extends MouseAdapter implements LeeRed{	
	...
	public SolarSis(){
		...
		marteTransX = Posi.translate(marteRotX, new Vector3f(0.0f, 0.0f, 0.5f));
	...
	public void cambiarVistaMouse(MouseEvent e){
    		...
    		if (result == null) {
       			...
       			if (p != null) {
        			...
        			viewVector = new Vector3f(.0f,.0f, .95f);
	...
	class ComboHandler implements AccionString{
		public void accion(String nombre){
 		...
 		public void cambiarVistaCombo(String nombre){ 
			...
			miniB.showPage(
              			"http://localhost:8080/"+nombre+".html", true);	
 	        }
	}
